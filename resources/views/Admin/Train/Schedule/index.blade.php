                            ...
                            <thead>
                              ...
                              @foreach ($schedule as $data)
                                  <tr>
                                    ...
                                    <td>
                                      <form class="" action="{{url('admin/schedule_train')}}/{{$data->id}}" method="post">
                                        <input type="hidden" name="_method" value="DELETE">
                                            <button type="submit" name="button" class="btn btn-oren btn btn-sm"> <i class="fa fa-trash"></i> </button>
                                            <a href="{{url('admin/schedule_train')}}/{{$data->id}}/edit" style="text-decoration:none"> <button type="button" name="button" class="btn btn-hijau btn btn-sm"><i class="fa fa-edit"></i></button>  </a>
                                             <button type="button" name="button" class="btn btn-biru btn btn-sm" onclick="bukajendela('{{url('admin/schedule_train')}}/{{$data->id}}')"><i class="fa fa-eye"></i>
                                        @csrf
                                      </form>
                                    </td>
                                  </tr>
